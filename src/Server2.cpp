...
int main(int argc, char const *argv[]) {
    ...
    std::cout << "Server using array of mutex method!" << std::endl;
    ...
    Ece420::SharedPoolAccess sharedPoolAccess(false, string_array_size);


    Ece420::Networking::socketIni(IP,
                                  port_number,
                                  number_of_client,
                                  Ece420::DataCommManager::arrayMutexComm,
                                  theArray,
                                  sharedPoolAccess);
